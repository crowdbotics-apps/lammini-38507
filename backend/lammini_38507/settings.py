"""
Django settings for lammini_38507 project.
...
ROOT_URLCONF = 'lammini_38507.urls'
...
WSGI_APPLICATION = 'lammini_38507.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lammini_38507 API",
    "DESCRIPTION": "API documentation for lammini_38507 App",
    "VERSION": "v1",
}
